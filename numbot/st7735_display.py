...
class ST7735Display:
    ...
    def __init__(self):
        ...
        self.spi_port = getattr(config, 'ST7735_SPI_PORT', 0)
        self.spi_cs = getattr(config, 'ST7735_SPI_CS', 0)
        self.dc_pin = getattr(config, 'ST7735_DC_PIN', 25)
        self.rst_pin = getattr(config, 'ST7735_RST_PIN', 27)
        self.bl_pin = getattr(config, 'ST7735_BL_PIN', 18)
        self.spi_speed = getattr(config, 'ST7735_SPI_SPEED', 24000000)
    ...
    def _init_display(self):
        ...
        self._write_data([0x02, 0x1c, 0x07, 0x12, 0x37, 0x32, 0x29, 0x2d,
