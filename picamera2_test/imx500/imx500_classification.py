#!/usr/bin/env python3
"""
imx500_classification.py - Image Classification บน IMX500 AI Camera

ทดสอบ:
1. โหลด MobileNet V2 model
2. รัน classification inference บน IMX500 chip
3. แสดง Top-3 predictions บน preview

Usage:
    python3 imx500_classification.py
    python3 imx500_classification.py --model /path/to/model.rpk

Source: Based on official Picamera2 IMX500 example
...
if __name__ == "__main__":
    ...
    print("=" * 60)
    print("IMX500 Image Classification Demo")
    print("=" * 60)
    print(f"\nModel: {args.model}")
    ...
    # Defaults - use ImageNet labels
    if intrinsics.labels is None:
        try:
            with open("assets/imagenet_labels.txt", "r") as f:
                intrinsics.labels = f.read().splitlines()
        except FileNotFoundError:
            print("Warning: ImageNet labels not found. Please provide --labels")
            print("You can download from: https://raw.githubusercontent.com/raspberrypi/picamera2/main/examples/imx500/assets/imagenet_labels.txt")
            exit(1)
    ...
    print("[3] Starting camera with preview...")
    ...
    print("\n✓ Running image classification. Press Ctrl+C to stop.")
    print("-" * 60)
